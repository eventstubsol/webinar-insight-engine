...
export async function enhanceWebinarsWithAllData(webinars: any[], token: string, supabase?: any, userId?: string) {
  ...
  try {
    ...
    console.log(`[zoom-api][enhancement-orchestrator] Step 1/6: Enhancing with host information`);
    const webinarsWithHostInfo = await enhanceWebinarsWithHostInfo(webinars, token);
    
    // Step 2: Enhance with panelist data
    console.log(`[zoom-api][enhancement-orchestrator] Step 2/6: Enhancing with panelist data`);
    ...
    console.log(`[zoom-api][enhancement-orchestrator] Step 3/6: Enhancing with participant data`);
    ...
    console.log(`[zoom-api][enhancement-orchestrator] Step 4/6: Enhancing with recording data`);
    ...
    console.log(`[zoom-api][enhancement-orchestrator] Step 5/6: Enhancing with detailed settings`);
    const webinarsWithDetailedSettings = await batchEnhanceWebinarsWithDetailedSettings(webinarsWithRecordings, token, 5);
    
    // Step 6: 🔥 NEW - Enhance with actual timing data from instances and past webinar API
    console.log(`[zoom-api][enhancement-orchestrator] Step 6/6: 🔥 Enhancing with ACTUAL TIMING DATA (NEW)`);
    let enhancedWebinars = webinarsWithDetailedSettings;
    
    if (supabase && userId) {
      enhancedWebinars = await enhanceWebinarsWithComprehensiveTimingData(
    ...
    if (supabase && userId) {
      console.log(`[zoom-api][enhancement-orchestrator] Step 7: Storing recording data in database`);
